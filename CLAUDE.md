...
Next steps: (a) write plan/phase2_prompt_design.md and get Hitaansh's sign-off; (b) draft prompts/phase2_case_study_prompt_v1.md and prompts/phase2_flashcards_prompt_v1.md; (c) fresh-session test both on /phase1example; (d) re-map the sec 7 pipeline plan onto the two-phase split (schema freeze stays PAUSED, backlog 1b).
